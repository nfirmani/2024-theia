...
import { Elemento2CommandContribution, Elemento3CommandContribution, MyExampleFormCommandContribution, MyExampleFormMenuContribution} from './my-example-contribution';
